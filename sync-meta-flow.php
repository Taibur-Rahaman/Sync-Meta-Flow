 ...
 * Description: Easy WooCommerce Meta tracking, attribution, order-flow, ROAS and courier intelligence with no-code setup.
 * Version: 1.4.0
...
define('SMF_VERSION','1.4.0');define('SMF_FILE',__FILE__);define('SMF_DIR',plugin_dir_path(__FILE__));define('SMF_URL',plugin_dir_url(__FILE__));

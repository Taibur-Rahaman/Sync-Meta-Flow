 ...
 * Description: WooCommerce Meta revenue intelligence with first/last-touch attribution, order-flow, customer quality, ROAS, profitability, diagnostics, privacy controls and courier intelligence.
 * Version: 2.0.1
...
define('SMF_VERSION','2.0.1'); define('SMF_FILE',__FILE__); define('SMF_DIR',plugin_dir_path(__FILE__)); define('SMF_URL',plugin_dir_url(__FILE__));

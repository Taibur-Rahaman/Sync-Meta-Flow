...
class SMF_Privacy {
    ...
    public static function export($email, $page = 1) {
        ...
        foreach ($ids as $order_id) {
            ...
            if ($events || $queue || $courier) {
                $data[] = array('name' => 'Sync Meta Flow order data', 'value' => wp_json_encode(array('order_id' => $order_id, 'order_events' => $events, 'capi_queue' => $queue, 'courier_events' => $courier)), 'extra_data' => array());
            }
        }

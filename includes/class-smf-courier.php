...
class SMF_Courier {
    ...
    public static function save() {
        ...
        if (isset($_POST['webhook_secret']) && trim((string)wp_unslash($_POST['webhook_secret'])) !== '') update_option('smf_courier_webhook_secret',sanitize_text_field(wp_unslash($_POST['webhook_secret'])),false);

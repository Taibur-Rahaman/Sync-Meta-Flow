...
foreach(array('smf_version','smf_meta_enabled','smf_meta_pixel_id','smf_meta_access_token','smf_meta_ad_account_id','smf_meta_sync_days','smf_meta_last_sync','smf_meta_last_sync_count','smf_meta_last_sync_error','smf_meta_account_currency','smf_courier_webhook_secret','smf_courier_provider','smf_steadfast_api_key','smf_steadfast_secret_key','smf_delete_data_on_uninstall') as $option)delete_option($option);

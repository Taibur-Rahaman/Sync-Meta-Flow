...
foreach(array('smf_version','smf_meta_enabled','smf_meta_pixel_id','smf_meta_access_token','smf_meta_ad_account_id','smf_meta_sync_days','smf_meta_last_sync','smf_meta_last_sync_count','smf_meta_last_sync_error','smf_meta_account_currency','smf_courier_webhook_secret','smf_courier_provider','smf_steadfast_api_key','smf_steadfast_secret_key','smf_courier_risk_window','smf_courier_processing_sla','smf_courier_delivery_sla','smf_courier_auto_ship','smf_attribution_model','smf_delete_data_on_uninstall','smf_cogs_percent','smf_payment_fee_percent','smf_courier_delivery_cost','smf_courier_return_cost') as $option)delete_option($option);
wp_clear_scheduled_hook('smf_process_capi_queue');wp_clear_scheduled_hook('smf_sync_meta_spend');wp_clear_scheduled_hook('smf_courier_recovery');
